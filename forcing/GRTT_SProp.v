...
Next Obligation.
  ...
  { induction p.
    - intros p0 α p' α'.
      ...
      * simpl. f_equal.
        ...
        intros q.
        destruct q.
        ** apply functional_extensionality_dep. intros α1.
           reflexivity.
        ** intros. apply functional_extensionality_dep. intros α1.
    ...
    - simpl. intros.
      ...
      * simpl. f_equal.
        ...
        destruct q.
        ** reflexivity.
        ** apply functional_extensionality_dep. intros α1. simpl.
           simple refine
           ...
           change (fixp_ᵗ p0 (fun (p1 : nat_obj) (α : p0 ≥ p1) => A' p1 (α ∘ sle_Sn_Sm α0))
         (fun (p1 : nat_obj) (α : p0 ≥ p1) => f' p1 (α ∘ sle_Sn_Sm α0)) q
         (sle_Sn_Sm (α1 ∘ α')) = fixp_ᵗ q
    (fun (p3 : nat_obj) (α : q ≥ p3) => A p3 ((((α ∘ (sle_Sn q)) ∘ α1) ∘ α') ∘ α0))
    (fun (p3 : nat_obj) (α : q ≥ p3) => f p3 ((((α ∘ (sle_Sn q)) ∘ α1) ∘ α') ∘ α0)) q (# q)).
           rewrite HH. clear HH.
           symmetry.
  ...
  exact (functional_extensionality_dep _ _ (fun (a : p ≥ p0) => H p0 a p0 (# p0))).
  (* NOTE : almost works --- run into "Bad relevance issue" again *)
Admitted.
